[README.md](https://github.com/user-attachments/files/26605695/README.md)
# 🚀 Nexus Financeiro

Sistema de gestão de cobranças e inadimplência, desenvolvido para controle de parcelas, clientes e KPIs financeiros. Backend em Node.js com autenticação JWT e frontend em React.
...
│   └── nexus.db            ← Banco de dados (gerado automaticamente)
│
├── scripts/
...
Aceita planilhas com abas por mês (JANEIRO, FEVEREIRO, etc.) no formato XCredit. Não duplica clientes existentes.
...
```bash
rm db/nexus.db db/nexus.db-shm db/nexus.db-wal
npm start
```
