# Xcredit Financeira — Frontend React
...
### 1. Pré-requisitos
- Node.js 18+
- Backend rodando na porta 3000 (`cd xcredit-final && npm start`)
...
O build vai para `xcredit-final/public/` (configurado no `vite.config.js`).
